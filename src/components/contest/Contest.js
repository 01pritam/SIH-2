...
//   const handleSubmit = () => {
//     // Validate and process the new contest data
...
//       <div className="contest-form"> {/* Add the class name for the form */}
...
//         />
//         <button onClick={handleSubmit}>Submit Contest</button>
//       </div>

//       {/* To-Do List for adding problems */}
//       <h2>Add Problems</h2>
//       <div className="todo-list"> {/* Add the class name for the to-do list */}
//         <input
//           type="text"
...
//       <div className="submitted-contests"> {/* Add the class name for the submitted contests */}
//         <ul>
...
//     <div className="contest-page"> {/* Add the class name here */}
//       <h1>Create a New Contest</h1>
//       {authToken ? ( // Check if authToken is available
//         <div className="contest-form"> {/* Add the class name for the form */}
//           <label htmlFor="title">Title:</label>
//           <input
//             type="text"
...
//         </div>
//       ) : (
//         <p>Please login to create a contest.</p> // Display "Please login" message if authToken is not available
//       )}
